...
; Date of completed work:7/18/2022
;
; *******************************
...
; *********************************************
	...
	clr r16
	clr r17
start:; don't press the button too fast, otherwise it won't work
	push r20
	ldi r20, 0
	sts BUTTON_COUNT, r20
	sts BUTTON_COUNT+1, r20
	sts DISPLAY_TEXT, r20
	sts BUTTON_PREVIOUS, r20
	sts BUTTON_CURRENT, r20
	pop r20
main_loop:
...
part4:
	...
	push r17
	ldi r16, 0
	lds r17, part4_index ;everytime only write one column 
	push r16
	push r17
	rcall lcd_gotoxy
	pop r17
	...
	cpi r17, 0x01
	pop r17
	breq done;check am I still holding the button, if previous is 1 then I won't generate the dot or dash yet
	...
	cpi r16, 0x15; the first 0.1 I did not count
	brlo is_dot
	push r16
	ldi r16, 0x00
...
button_push:
	...
	sts BUTTON_CURRENT, r16
	lds r17, BUTTON_PREVIOUS
	cp r16, r17; check if the current button state is same as the previous button state, if so then I am still holding the button
	breq timer4_holding
		;when code gets here means  I stop press the button now
	ldi r18, 0x01
	clr r19
	lds ZL, BUTTON_COUNT
...
timer4_holding:
	...
	lds r16, BUTTON_LENGTH; inc the timer while I am holding the button
	inc r16
	sts BUTTON_LENGTH, r16
